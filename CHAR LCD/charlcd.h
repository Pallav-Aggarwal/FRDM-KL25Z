...
Character LCD 8/4 Bit Interface 16x2, 20x4, 40x4
...
#define LCD_INTERFACE             FOUR_BIT_RANDOM
...
#define FOUR_BIT_RANDOM           3 //(WORKING OK)
    ...
    #define D4_PORT_SET           PTD->PDOR
		#define D4_PORT_CLR           PTD->PCOR
    #define D4_PIN                4
		
    #define D5_PORT_SET           PTD->PDOR
		#define D5_PORT_CLR           PTD->PCOR
    #define D5_PIN                5
		
    #define D6_PORT_SET           PTD->PDOR
		#define D6_PORT_CLR           PTD->PCOR
    #define D6_PIN                6
		
    #define D7_PORT_SET           PTD->PDOR
		#define D7_PORT_CLR           PTD->PCOR
    #define D7_PIN                7
#endif
...
//LCD Control Pins
#define RS_PORT_SET      PTD->PDOR
#define RS_PORT_CLR      PTD->PCOR
#define RS_PIN           1

#define EN_PORT_SET      PTD->PDOR
#define EN_PORT_CLR      PTD->PCOR
#define EN_PIN           6
